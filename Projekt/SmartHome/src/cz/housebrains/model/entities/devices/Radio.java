...
public class Radio extends Device {
    ...
    private HouseController houseController = HouseController.getInstance();

    /**
     * Creates new Radio/HiFi with given name and consumption in given room.
     * @param name name of the device
     * @param room room for device to spawn in
     * @param consumption consumption of the device
     */
    public Radio(String name, Room room, Consumption consumption) {
        super(name, room, consumption);
    }

    /**
     * Override method for using radio, as it can be used by multiple people at the same time.
